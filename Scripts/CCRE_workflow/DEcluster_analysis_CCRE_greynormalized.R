...
# Normalized by grey eigenexon (subtract to other cluster's eigenexons and then re-normalize, then run GLMS and FDR)
# Initialize script
date()
rm(list=ls())
library(ggplot2)
...
## Subtract grey ME to other MEs
# store and remove grey eigenexon values
