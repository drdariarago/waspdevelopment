...
newdir<-file.path(getwd(), "Output/sex_modularity_biweight_2_01")
dir.create(newdir)
graphdir<-file.path(getwd(), "Graphics/sex_modularity_biweight_2_01")
dir.create(graphdir)
...
load(file="./Output/WGCNA_clustering_biweight/t_nasdevgeneexon.RData")
